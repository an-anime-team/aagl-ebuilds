...
# 3. Note the commit number of anime-game-core (the code after anime-game-core @ xxxxxxx) and blueprint-compiler
# 4. Put the commit numbers into the variables below:
anime_game_core_commit=ecf84da
blueprint_compiler_commit=59283a7
...
DESCRIPTION="Open Source An Anime Game launcher for Linux with automatic anti-cheat patching and telemetry disabling, Rust/ Gtk version"
...
src_fetch() {
	# default
	git-r3_fetch $EGIT_REPO_URI_CORE ${anime_game_core_commit}
	git-r3_fetch $EGIT_REPO_URI_BC ${blueprint_compiler_commit}
}

src_unpack() {
	cargo_src_unpack
	git-r3_checkout $EGIT_REPO_URI_CORE ${WORKDIR}/${P}/anime-game-core
	git-r3_checkout $EGIT_REPO_URI_BC ${WORKDIR}/${P}/blueprint-compiler
}
